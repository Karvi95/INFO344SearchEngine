...
namespace SearchInfrastructureLibrary
{
    public class StorageMaster
    {
        ...
        private static CloudTable searchQueryTable; // Table containing an inverted index to map words in title to URL
        ...
        public StorageMaster(string connectionString)
        {
            ...
            searchQueryTable = tableClient.GetTableReference("tableoftitles");
            searchQueryTable.CreateIfNotExists();
        ...
        public CloudTable GetSearchQueryTable()
        {
        ...
        public void clearAll()
        {
            ...
            searchQueryTable.DeleteIfExists();
